...
abstract class ActivityContributor {
    ...
    @ContributesAndroidInjector(modules = [FeedFriendDetailActivityModule::class,FeedFriendDetailActivityModuleProvider::class])
    @ActivityScope
    ...
    @ContributesAndroidInjector(modules = [FundingActivityModule::class,FundingActivityProvideModule::class])
    @ActivityScope
    abstract fun contributesFundingActivity() : FundingActivity
}